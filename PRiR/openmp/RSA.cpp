...
#pragma omp parallel shared (msgToDecodeSize, encodedNumbers, decodedMsg) private (decodedChar, intTaken, i)
#pragma omp for
...
#pragma omp parallel shared (msgToEncodeSize, encodedChars, msgToEncode) private (encodedChar, charTaken, i)
#pragma omp for
